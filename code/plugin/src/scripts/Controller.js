    ...
    sitemapExportDataFormChanged(element) {
        if (element.id === 'export-format') {
            if (element.value === 'csv') {
                ...
                $('#export-data-as-db-btn').hide();
            } else if (element.value === 'jsonl') {
                $('#delimiter-option').hide();
                $('#export-data-as-db-btn').hide();
            } else if (element.value === 'db') {
                $('#delimiter-option').hide();
                $('#export-data-as-file').hide();
                $('#export-data-as-file-btn').hide();
                $('#export-data-as-db-btn').show();
            } else {
                $('#delimiter-option').hide();
                $('#export-data-as-db-btn').hide();
            }
